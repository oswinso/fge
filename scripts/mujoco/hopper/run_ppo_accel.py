...
from fge.core.envs.mujoco.hopper.analyze_ppo import plot_train, plot_train_x0, plot_eval_det
...
def main(
    ...
    task_cfg = hopper.TaskCfg(max_steps=max_env_steps, px0_bounds=px0_bounds)

...
# from fge.core.envs.toylevels.analyze_ppo import plot_eval_det, plot_train, plot_train_x0
...
def main(
    ...
    vds_cfg = VDSGAE.Cfg(lr=8e-4, gae_lambda=0.95, disc_gamma=0.995, n_batches=n_batch, n_update_epochs=n_update_epoch)
